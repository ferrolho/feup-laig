...
private:
	...
	const vector<Primitive*> parsePrimitives(TiXmlElement* element, Texture* texture);
	Rectangle* parseRectangle(TiXmlElement* primitive, Texture* texture);
	Triangle* parseTriangle(TiXmlElement* primitive, Texture* texture);
